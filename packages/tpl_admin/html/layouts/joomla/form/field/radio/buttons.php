...
$classToggle = $isBtnGroup ? 'uk-checkbox' : 'uk-checkbox';
$btnClass    = $isBtnGroup ? 'uk-button uk-button-outline-secondary' : 'form-check-label';
	...
	<div class="<?php echo $containerClass; ?>">
		<?php foreach($options as $i => $option) : ?>
			...
			if($isBtnYesNo)
			{
				...
				{
					case '0':
						$btnClass = 'uk-button uk-button-outline-danger';
						break;
					case '1':
						$btnClass = 'uk-button uk-button-outline-success';
						break;
					default:
						$btnClass = 'uk-button uk-button-outline-secondary';
						break;
				}
			}
