...
<div class="uk-position-relative">
	...
	<?php if(!$lock) : ?>
		<button type="button" class="uk-form-icon uk-form-icon-flip tm-button-link input-password-toggle">
			<span class="icon-eye icon-fw" aria-hidden="true"></span>
			<span class="visually-hidden sr-only" hidden=""><?php echo Text::_('JSHOWPASSWORD'); ?></span>
		</button>
	<?php else : ?>
		<button type="button" id="<?php echo $id; ?>_lock" class="uk-form-icon uk-form-icon-flip btn btn-info input-password-modify locked">
