	...
	<?php if($type === 'logout') : ?>
		<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
			...
			<?php if($params->get('slogin_link_auch_edit', 1) == 1) : ?>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=profile&layout=edit'); ?>"><?php echo JText::_('MOD_SLOGIN_EDIT_YOUR_PROFILE'); ?></a>
			<?php endif; ?>
			...
			<?php if($show_fusion_form == 1) : ?>
				<ul class="uk-child-width-expand uk-grid-small uk-grid" data-uk-grid>
					...
					<li>
						<div class="uk-text-warning uk-margin"><?php echo JText::_('TPL_ADMIN_ATTACH_PROVIDERS_MODULE') ?></div>
					...
					<li class="uk-width-auto uk-text-right">
						<?php
						$logout = 'index.php?option=com_users&task=user.logout&' . JSession::getFormToken() . '=1&return=' . base64_encode(JURI::base() . 'account');
						?>
